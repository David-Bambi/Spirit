 ...
 * @tparam HasColor
 */
template <bool HasNormal, bool HasTexture, bool HasColor>
struct Vertex
{
    glm::vec3 position;
    explicit Vertex(glm::vec3 pos) : position(pos) {}
};
...
struct Vertex<false, false, true>
{
    ...
    explicit Vertex(glm::vec3 pos, Color_t col) : position(pos), color(col) {}
};
...
struct Vertex<false, true, true>
{
    ...
    explicit Vertex(glm::vec3 pos, glm::vec2 tex, Color_t col)
...
struct Vertex<false, true, false>
{
    ...
    explicit Vertex(glm::vec3 pos, glm::vec2 tex) : position(pos), texture(tex) {}
};
