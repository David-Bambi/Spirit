...
GF2DCircle::GF2DCircle(unsigned int shaderprogram, float smoothing, GFColor color,
                       unsigned int texture, unsigned int usage)
{
    VectorStruc VecStr = {};
...
void GF2DCircle::PrepareRendering()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices_in_array), vertices_in_array, GL_STATIC_DRAW);

    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, EBO);
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(index_in_array), index_in_array, this->_usage);
