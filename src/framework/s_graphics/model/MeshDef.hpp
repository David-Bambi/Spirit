...
namespace MeshDef
{
     ...
     *  2           3
     */
    std::vector<glm::vec3> TriangleV = {glm::vec3(-1.0f, -1.0f, 0.0f),   // 0
                                        glm::vec3( 0.0f,  1.0f, 0.0f),   // 1
                                        glm::vec3( 1.0f, -1.0f, 0.0f)    // 2
                                       }; 
    
    std::vector<glm::vec2> TriangleT = {glm::vec2( 0.0f,  0.0f),   // 0
    ...
    std::vector<glm::vec3> RectangleV = {glm::vec3(-1.0f,  1.0f, 0.0f),   // 0
    ...
    /** Indexs of rectangle */                                    
     std::vector<unsigned int> RectangleI = { 0, 1, 3,
                                              0, 2, 3
                                            };

    std::vector<glm::vec2> RectangleT = {glm::vec2( 0.0f,  1.0f),   // 0
